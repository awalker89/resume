  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Ensure each message block has consistent vertical spacing; keep it tight */}
        <div className="aui-thread-messages flex flex-col gap-3">
      ...
      {/* Move the composer outside the scroll area to avoid overlap */}
      <div className="aui-thread-composer-container mx-auto w-full max-w-(--thread-max-width) px-4 pt-2 pb-4 border-t bg-background">
        <Composer />
      </div>
    </ThreadPrimitive.Root>
  );
...
const AssistantMessage: FC = () => {
  return (
    <MessagePrimitive.Root
      className="aui-assistant-message-root fade-in slide-in-from-bottom-1 relative z-0 mx-auto mb-3 w-full max-w-(--thread-max-width) animate-in py-3 duration-150 ease-out"
      data-role="assistant"
    >
      ...
      {/* Reserve extra space so floating controls don't overlap the next message */}
      <div className="aui-assistant-message-footer mt-2 ml-2 flex pb-2">
        <BranchPicker />
        <AssistantActionBar />
      </div>
    </MessagePrimitive.Root>
...
const AssistantActionBar: FC = () => {
  return (
    <ActionBarPrimitive.Root
      ...
      autohide="not-last"
      autohideFloat="never"
      className="aui-assistant-action-bar-root -ml-1 col-start-3 row-start-2 z-10 flex gap-1 text-muted-foreground data-floating:absolute data-floating:rounded-md data-floating:border data-floating:bg-background data-floating:p-1 data-floating:shadow-sm"
    >
...
const UserMessage: FC = () => {
  return (
    <MessagePrimitive.Root
      className="aui-user-message-root fade-in slide-in-from-bottom-1 mx-auto grid w-full max-w-(--thread-max-width) animate-in auto-rows-auto grid-cols-[minmax(72px,1fr)_auto] content-start gap-y-2 px-2 py-3 duration-150 ease-out [&:where(>*)]:col-start-2"
      data-role="user"
    >
      <UserMessageAttachments />
      ...
      <div className="aui-user-message-content-wrapper relative col-start-2 min-w-0">
        ...
        <div className="aui-user-action-bar-wrapper -translate-x-full -translate-y-1/2 absolute top-1/2 left-0 z-10 pr-2">
          <UserActionBar />
        </div>
      </div>
    ...
    <MessagePrimitive.Root className="aui-edit-composer-wrapper mx-auto flex w-full max-w-(--thread-max-width) flex-col gap-4 px-2">
      <ComposerPrimitive.Root className="aui-edit-composer-root ml-auto flex w-full max-w-7/8 flex-col rounded-xl bg-muted">
        <ComposerPrimitive.Input
          ...
          // Avoid autoFocus to improve accessibility and prevent unexpected viewport jumps
        />
